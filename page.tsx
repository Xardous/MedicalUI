...
import { Button } from "C:/Users/Tanish S/Documents/nextjs/projects/my-app/components/ui/button";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "C:/Users/Tanish S/Documents/nextjs/projects/my-app/components/ui/select";
import { Alert, AlertDescription, AlertTitle } from "C:/Users/Tanish S/Documents/nextjs/projects/my-app/components/ui/alert";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "C:/Users/Tanish S/Documents/nextjs/projects/my-app/components/ui/card";
import { Slider } from "C:/Users/Tanish S/Documents/nextjs/projects/my-app/components/ui/slider";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "C:/Users/Tanish S/Documents/nextjs/projects/my-app/components/ui/tooltip";
import * as tf from '@tensorflow/tfjs';
import '@tensorflow/tfjs-backend-webgl';

const diseaseFacts = {
  covid19: "fact here",
  breastCancer: "fact here",
};
...
export default function MedicalImageAnalyzer() {
  ...
  useEffect(() => {
    async function loadModel() {
      const loadedModel = await tf.loadLayersModel('model here');
  ...
  const handleAnalyze = async () => {
    ...
    const detectedDisease = classIndex % 2 === 0 ? 'covid19' : 'breastCancer';
          ...
          >
            <Card className="bg-gray-800 border-cyan-500 shadow-lg shadow-cyan-500/20">
              ...
              <CardContent className="space-y-4">
                <Select onValueChange={(value: "covid-19"|"breast cancer") => setAnalysisType(value)}>
